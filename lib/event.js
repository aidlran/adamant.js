 ...
 * @property {function(callback:function(fn:function)=):EventHandler} fire
 *
 * Fire the event.
 *
 * If a callback is provided, it is invoked once for each registered function
 * (which is passed to the callback's first parameter)
 *
 * Otherwise, each registered function is called without parameters.
 *
 * Functions are called in the order that they were registered.
 */
